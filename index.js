...
function startHtml() {
    ...
    <body>
        ...
        <div class="container">
            <div class="row">`;
    fs.writeFile("./dist/profile.html", html, function(err) {
        if (err) {
            console.log(err);
        }
    });
...
function addHtml(member) {
    return new Promise (function(resolve, reject) {
        ...
        if (role === 'Engineer') {
            ...
            const managerOffice = member.getOfficeNumber();
            data = `<div class="col-6">
            <div class="card mx-auto mb-3" style="width: 18rem">
        ...
        fs.appendFile('./dist/profile.html', data, function (err) {
            if (err) {
                return reject(err);
            };
            return resolve();
...
function finishHtml() {
    ...
    fs.appendFile('./dist/profile.html', html, function (err) {
        if (err) {
            console.log(err);
        };
    });
